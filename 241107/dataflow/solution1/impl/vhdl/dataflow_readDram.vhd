...
architecture behav of dataflow_readDram is 
...
attribute shreg_extract : string;
    ...
    signal tmp_i_reg_208 : STD_LOGIC_VECTOR (2 downto 0);
    signal add_ln5_fu_150_p2 : STD_LOGIC_VECTOR (1 downto 0);
    signal add_ln5_reg_216 : STD_LOGIC_VECTOR (1 downto 0);
    signal ap_CS_fsm_state71 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state71 : signal is "none";
    signal empty_37_fu_156_p1 : STD_LOGIC_VECTOR (0 downto 0);
    signal empty_37_reg_221 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln5_fu_144_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal input_buf_addr_reg_225 : STD_LOGIC_VECTOR (2 downto 0);
    signal ap_CS_fsm_state72 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state72 : signal is "none";
    signal input_buf_1_addr_reg_230 : STD_LOGIC_VECTOR (2 downto 0);
    signal add_ln7_fu_181_p2 : STD_LOGIC_VECTOR (1 downto 0);
    signal add_ln7_reg_238 : STD_LOGIC_VECTOR (1 downto 0);
    signal gmem0_addr_read_reg_243 : STD_LOGIC_VECTOR (7 downto 0);
    signal wi_reg_110 : STD_LOGIC_VECTOR (1 downto 0);
    signal ap_CS_fsm_state74 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state74 : signal is "none";
    signal zext_ln10_1_fu_169_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_block_state1 : BOOLEAN;
    signal hi_fu_64 : STD_LOGIC_VECTOR (1 downto 0);
    signal icmp_ln7_fu_175_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal zext_ln10_fu_160_p1 : STD_LOGIC_VECTOR (2 downto 0);
    signal add_ln10_fu_164_p2 : STD_LOGIC_VECTOR (2 downto 0);
...
begin
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((ap_continue = ap_const_logic_1)) then 
                    ap_done_reg <= ap_const_logic_0;
                elsif (((icmp_ln5_fu_144_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state71))) then 
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if (((icmp_ln5_fu_144_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state71))) then 
    ...
    hi_fu_64_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((not(((ap_done_reg = ap_const_logic_1) or (ap_start = ap_const_logic_0) or (m_axi_gmem0_ARREADY = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
                hi_fu_64 <= ap_const_lv2_0;
            elsif (((icmp_ln7_fu_175_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state72))) then 
                hi_fu_64 <= add_ln5_reg_216;
            end if; 
        end if;
    end process;

    wi_reg_110_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln5_fu_144_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state71))) then 
                wi_reg_110 <= ap_const_lv2_0;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state72)) then
                ...
                input_buf_1_addr_reg_230 <= zext_ln10_1_fu_169_p1(3 - 1 downto 0);
                input_buf_addr_reg_225 <= zext_ln10_1_fu_169_p1(3 - 1 downto 0);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state70)) then
                    tmp_i_reg_208(2 downto 1) <= tmp_i_fu_133_p3(2 downto 1);
            end if;
        end if;
    end process;
    tmp_i_reg_208(0) <= '0';

    ap_NS_fsm_assign_proc : process (ap_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, m_axi_gmem0_ARREADY, m_axi_gmem0_RVALID, ap_CS_fsm_state73, ap_CS_fsm_state71, icmp_ln5_fu_144_p2, ap_CS_fsm_state72, icmp_ln7_fu_175_p2)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state72 => 
                if (((icmp_ln7_fu_175_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state72))) then
                    ap_NS_fsm <= ap_ST_fsm_state71;
                else
                    ap_NS_fsm <= ap_ST_fsm_state73;
                end if;
            when ap_ST_fsm_state73 => 
                if (((ap_const_logic_1 = ap_CS_fsm_state73) and (m_axi_gmem0_RVALID = ap_const_logic_1))) then
    ...
    add_ln10_fu_164_p2 <= std_logic_vector(unsigned(tmp_i_reg_208) + unsigned(zext_ln10_fu_160_p1));
    add_ln5_fu_150_p2 <= std_logic_vector(unsigned(hi_fu_64) + unsigned(ap_const_lv2_1));
    add_ln7_fu_181_p2 <= std_logic_vector(unsigned(wi_reg_110) + unsigned(ap_const_lv2_1));
    ...
    ap_ST_fsm_state73_blk_assign_proc : process(m_axi_gmem0_RVALID)
    begin
    ...
    ap_done_assign_proc : process(ap_done_reg, ap_CS_fsm_state71, icmp_ln5_fu_144_p2)
    begin
        if (((icmp_ln5_fu_144_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state71))) then 
    ...
    ap_ready_assign_proc : process(ap_CS_fsm_state71, icmp_ln5_fu_144_p2)
    begin
        if (((icmp_ln5_fu_144_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state71))) then 
    ...
    ap_return_assign_proc : process(channel_i, ap_CS_fsm_state71, icmp_ln5_fu_144_p2, ap_return_preg)
    begin
        if (((icmp_ln5_fu_144_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state71))) then 
            ap_return <= channel_i;
        else 
    ...
    empty_37_fu_156_p1 <= hi_fu_64(1 - 1 downto 0);
    ...
    gmem0_blk_n_R_assign_proc : process(m_axi_gmem0_RVALID, ap_CS_fsm_state73)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state73)) then 
    ...
    icmp_ln5_fu_144_p2 <= "1" when (hi_fu_64 = ap_const_lv2_2) else "0";
    icmp_ln7_fu_175_p2 <= "1" when (wi_reg_110 = ap_const_lv2_2) else "0";
    input_buf_1_address0 <= input_buf_1_addr_reg_230;

    input_buf_1_ce0_assign_proc : process(ap_CS_fsm_state74)
    begin
    ...
    input_buf_1_d0 <= gmem0_addr_read_reg_243;

    input_buf_1_we0_assign_proc : process(empty_37_reg_221, ap_CS_fsm_state74)
    begin
        if (((empty_37_reg_221 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state74))) then 
    ...
    input_buf_address0 <= input_buf_addr_reg_225;

    input_buf_ce0_assign_proc : process(ap_CS_fsm_state74)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state74)) then 
    ...
    input_buf_d0 <= gmem0_addr_read_reg_243;

    input_buf_we0_assign_proc : process(empty_37_reg_221, ap_CS_fsm_state74)
    begin
        if (((empty_37_reg_221 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state74))) then 
    ...
    m_axi_gmem0_ARLEN <= ap_const_lv32_4;
    ...
    m_axi_gmem0_RREADY_assign_proc : process(m_axi_gmem0_RVALID, ap_CS_fsm_state73)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state73) and (m_axi_gmem0_RVALID = ap_const_logic_1))) then 
    ...
    zext_ln10_1_fu_169_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln10_fu_164_p2),64));
    zext_ln10_fu_160_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(wi_reg_110),3));
end behav;
