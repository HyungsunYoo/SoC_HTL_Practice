...
output   ap_idle;
output   ap_ready;
output  [1:0] output_buf_address0;
...
reg    output_r_blk_n;
reg   [63:0] output_read_reg_220;
wire    ap_CS_fsm_state2;
reg   [60:0] trunc_ln_reg_233;
wire   [0:0] icmp_ln87_fu_147_p2;
wire   [63:0] zext_ln89_fu_142_p1;
wire  signed [63:0] sext_ln91_fu_196_p1;
reg   [63:0] shiftreg_fu_76;
wire   [63:0] or_ln_fu_183_p3;
wire    ap_CS_fsm_state3;
reg    ap_block_state1;
reg   [1:0] ki_fu_80;
wire   [1:0] add_ln87_fu_153_p2;
wire   [1:0] shl_ln89_fu_136_p2;
wire   [31:0] lshr_ln_fu_173_p4;
reg   [72:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((1'b1 == ap_CS_fsm_state73) & (m_axi_gmem1_BVALID == 1'b1))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((~((ap_done_reg == 1'b1) | (ap_start == 1'b0) | (output_r_empty_n == 1'b0)) & (1'b1 == ap_CS_fsm_state1))) begin
        ki_fu_80 <= 2'd0;
    end else if (((1'b1 == ap_CS_fsm_state2) & (icmp_ln87_fu_147_p2 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state2) & (icmp_ln87_fu_147_p2 == 1'd1))) begin
        trunc_ln_reg_233 <= {{output_read_reg_220[63:3]}};
    end
end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state73) & (m_axi_gmem1_BVALID == 1'b1))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state4) & (m_axi_gmem1_AWREADY == 1'b1))) begin
...
assign add_ln87_fu_153_p2 = (ki_fu_80 + 2'd1);
...
assign icmp_ln87_fu_147_p2 = ((ki_fu_80 == 2'd2) ? 1'b1 : 1'b0);

assign lshr_ln_fu_173_p4 = {{shiftreg_fu_76[63:32]}};
...
assign m_axi_gmem1_AWADDR = sext_ln91_fu_196_p1;
...
assign m_axi_gmem1_WDATA = shiftreg_fu_76;

assign m_axi_gmem1_WID = 1'd0;

assign m_axi_gmem1_WLAST = 1'b0;

assign m_axi_gmem1_WSTRB = 8'd255;

assign m_axi_gmem1_WUSER = 1'd0;

assign or_ln_fu_183_p3 = {{output_buf_q0}, {lshr_ln_fu_173_p4}};

assign output_buf_address0 = zext_ln89_fu_142_p1;

assign sext_ln91_fu_196_p1 = $signed(trunc_ln_reg_233);

assign shl_ln89_fu_136_p2 = ki_fu_80 << 2'd1;

assign zext_ln89_fu_142_p1 = shl_ln89_fu_136_p2;

endmodule //dataflow_writeDram
