...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "dataflow.autotvin.dat"
	set constFileTvOut       "dataflow.autotvout.dat"
	set constFileHdlTvIn     "dataflow.autohdltvin.dat"
	set constFileHdlTvOut    "dataflow.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
