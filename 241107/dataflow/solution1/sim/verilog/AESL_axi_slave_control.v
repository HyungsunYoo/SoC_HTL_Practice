...
//------------------------Parameter----------------------
`define TV_IN_output_r "../tv/cdatafile/c.dataflow.autotvin_output_r.dat"
...
parameter dataflow_continue_addr = 0;
parameter dataflow_auto_start_addr = 0;
parameter input_r_data_in_addr = 16;
parameter weight_data_in_addr = 28;
...
assign TRAN_control_write_data_finish = 1 & output_r_write_data_finish;
