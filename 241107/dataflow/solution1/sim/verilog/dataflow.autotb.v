...
`define AUTOTB_DUT      dataflow
`define AUTOTB_DUT_INST AESL_inst_dataflow
`define AUTOTB_TOP      apatb_dataflow_top
`define AUTOTB_LAT_RESULT_FILE "dataflow.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "dataflow.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_dataflow_top
...
`define AUTOTB_TVIN_gmem0_out_wrapc  "../tv/rtldatafile/rtl.dataflow.autotvin_gmem0.dat"
`define AUTOTB_TVIN_gmem2_out_wrapc  "../tv/rtldatafile/rtl.dataflow.autotvin_gmem2.dat"
`define AUTOTB_TVIN_output_r_out_wrapc  "../tv/rtldatafile/rtl.dataflow.autotvin_output_r.dat"
`define AUTOTB_TVOUT_gmem1  "../tv/cdatafile/c.dataflow.autotvout_gmem1.dat"
`define AUTOTB_TVOUT_gmem1_out_wrapc  "../tv/rtldatafile/rtl.dataflow.autotvout_gmem1.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 454;
parameter LENGTH_input_r = 1;
parameter LENGTH_weight = 1;
parameter LENGTH_output_r = 1;
parameter LENGTH_gmem0 = 64;
parameter LENGTH_gmem1 = 32;
parameter LENGTH_gmem2 = 64;
