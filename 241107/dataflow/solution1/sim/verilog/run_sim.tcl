...
if {[file isfile dataflow.autotvin.dat]} {
	file delete -force dataflow.autotvin.dat
}

if {[file isfile dataflow.autotvout.dat]} {
	file delete -force dataflow.autotvout.dat
}
