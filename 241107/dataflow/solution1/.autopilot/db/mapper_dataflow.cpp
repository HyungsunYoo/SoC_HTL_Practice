...
extern "C" void dataflow(char*, char*, long long*, int, int, int);
extern "C" void apatb_dataflow_hw(volatile void * __xlx_apatb_param_input_r, volatile void * __xlx_apatb_param_weight, volatile void * __xlx_apatb_param_output_r) {
  ...
  vector<sc_bv<8> >__xlx_input_r__tmp_vec;
  for (int j = 0, e = 64; j != e; ++j) {
    __xlx_input_r__tmp_vec.push_back(((char*)__xlx_apatb_param_input_r)[j]);
  }
  int __xlx_size_param_input_r = 64;
  int __xlx_offset_param_input_r = 0;
  int __xlx_offset_byte_param_input_r = 0*1;
  char* __xlx_input_r__input_buffer= new char[__xlx_input_r__tmp_vec.size()];
  for (int i = 0; i < __xlx_input_r__tmp_vec.size(); ++i) {
    __xlx_input_r__input_buffer[i] = __xlx_input_r__tmp_vec[i].range(7, 0).to_uint64();
  }
  // Collect __xlx_weight__tmp_vec
  vector<sc_bv<8> >__xlx_weight__tmp_vec;
  for (int j = 0, e = 64; j != e; ++j) {
    __xlx_weight__tmp_vec.push_back(((char*)__xlx_apatb_param_weight)[j]);
  }
  int __xlx_size_param_weight = 64;
  int __xlx_offset_param_weight = 0;
  int __xlx_offset_byte_param_weight = 0*1;
  char* __xlx_weight__input_buffer= new char[__xlx_weight__tmp_vec.size()];
  for (int i = 0; i < __xlx_weight__tmp_vec.size(); ++i) {
    __xlx_weight__input_buffer[i] = __xlx_weight__tmp_vec[i].range(7, 0).to_uint64();
  }
  // Collect __xlx_output_r__tmp_vec
  vector<sc_bv<64> >__xlx_output_r__tmp_vec;
  ...
  int __xlx_size_param_output_r = 32;
  int __xlx_offset_param_output_r = 0;
  int __xlx_offset_byte_param_output_r = 0*8;
  long long* __xlx_output_r__input_buffer= new long long[__xlx_output_r__tmp_vec.size()];
  for (int i = 0; i < __xlx_output_r__tmp_vec.size(); ++i) {
    __xlx_output_r__input_buffer[i] = __xlx_output_r__tmp_vec[i].range(63, 0).to_uint64();
  }
  // DUT call
  dataflow(__xlx_input_r__input_buffer, __xlx_weight__input_buffer, __xlx_output_r__input_buffer, __xlx_offset_byte_param_input_r, __xlx_offset_byte_param_weight, __xlx_offset_byte_param_output_r);
// print __xlx_apatb_param_input_r
  sc_bv<8>*__xlx_input_r_output_buffer = new sc_bv<8>[__xlx_size_param_input_r];
  ...
  for (int i = 0; i < __xlx_size_param_input_r; ++i) {
    ((char*)__xlx_apatb_param_input_r)[i] = __xlx_input_r_output_buffer[i].to_uint();
  }
// print __xlx_apatb_param_weight
  sc_bv<8>*__xlx_weight_output_buffer = new sc_bv<8>[__xlx_size_param_weight];
  for (int i = 0; i < __xlx_size_param_weight; ++i) {
    __xlx_weight_output_buffer[i] = __xlx_weight__input_buffer[i+__xlx_offset_param_weight];
  }
  for (int i = 0; i < __xlx_size_param_weight; ++i) {
    ((char*)__xlx_apatb_param_weight)[i] = __xlx_weight_output_buffer[i].to_uint();
  }
