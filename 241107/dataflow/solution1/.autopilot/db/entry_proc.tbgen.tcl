...
set Spec2ImplPortList { 
	...
	output_r_c { ap_fifo {  { output_r_c_din fifo_port_we 1 64 }  { output_r_c_num_data_valid fifo_status_num_data_valid 0 3 }  { output_r_c_fifo_cap fifo_update 0 3 }  { output_r_c_full_n fifo_status 0 1 }  { output_r_c_write fifo_data 1 1 } } }
}
