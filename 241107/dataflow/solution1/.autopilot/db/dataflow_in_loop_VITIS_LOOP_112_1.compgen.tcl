...
set ID 27
set hasByteEnable 0
set MemName dataflow_dataflow_in_loop_VITIS_LOOP_112_1_input_buf_RAM_AUTO_1R1W_memcore
...
set MemName dataflow_dataflow_in_loop_VITIS_LOOP_112_1_input_buf_RAM_AUTO_1R1W
...
set ID 28
set hasByteEnable 0
set MemName dataflow_dataflow_in_loop_VITIS_LOOP_112_1_output_buf_RAM_AUTO_1R1W_memcore
set CoreName ap_simcore_mem
set PortList { 2 3 }
set DataWd 32
set AddrRange 4
...
set FullThresh 0
set CoreName ap_simcore_mem_df_channel
set MemName dataflow_dataflow_in_loop_VITIS_LOOP_112_1_output_buf_RAM_AUTO_1R1W
if {${::AESL::PGuard_autocg_gen} || ${::AESL::PGuard_simmodel_gen}} {
if {[info proc ap_gen_simcore_mem_df_channel] == "ap_gen_simcore_mem_df_channel"} {
    eval "ap_gen_simcore_mem_df_channel { \
    id ${ID} \
...
# FIFO definition: 
set ID 29
set FifoName dataflow_fifo_w64_d4_S
...
# FIFO definition: 
set ID 30
set FifoName dataflow_fifo_w2_d2_S
set InstName tmp_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set DualClock 0
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { channel_i { I 3 vector } channel_i_ap_vld { I 1 bit } } \
} "
}
