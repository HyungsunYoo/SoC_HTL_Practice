...
# 36 "C:/Xilinx/Vitis_HLS/2022.1/tps/mingw/8.3.0/win64.o/nt\\lib\\gcc\\x86_64-w64-mingw32\\8.3.0\\include\\c++\\stdlib.h" 3
...
# 42 "C:/Xilinx/Vitis_HLS/2022.1/tps/mingw/8.3.0/win64.o/nt\\lib\\gcc\\x86_64-w64-mingw32\\8.3.0\\include\\c++\\cstdlib" 2 3
# 75 "C:/Xilinx/Vitis_HLS/2022.1/tps/mingw/8.3.0/win64.o/nt\\lib\\gcc\\x86_64-w64-mingw32\\8.3.0\\include\\c++\\cstdlib" 3
...
# 627 "C:/Xilinx/Vitis_HLS/2022.1/tps/mingw/8.3.0/win64.o/nt\\x86_64-w64-mingw32\\include\\stdlib.h" 3
...
# 76 "C:/Xilinx/Vitis_HLS/2022.1/tps/mingw/8.3.0/win64.o/nt\\lib\\gcc\\x86_64-w64-mingw32\\8.3.0\\include\\c++\\cstdlib" 2 3
...
# 46 "C:/Xilinx/Vitis_HLS/2022.1/tps/mingw/8.3.0/win64.o/nt\\lib\\gcc\\x86_64-w64-mingw32\\8.3.0\\include\\c++\\bits/std_abs.h" 3
extern "C++"
{
namespace std
{
...
# 78 "C:/Xilinx/Vitis_HLS/2022.1/tps/mingw/8.3.0/win64.o/nt\\lib\\gcc\\x86_64-w64-mingw32\\8.3.0\\include\\c++\\cstdlib" 2 3
...
# 37 "C:/Xilinx/Vitis_HLS/2022.1/tps/mingw/8.3.0/win64.o/nt\\lib\\gcc\\x86_64-w64-mingw32\\8.3.0\\include\\c++\\stdlib.h" 2 3

using std::abort;
using std::atexit;
using std::exit;
# 51 "C:/Xilinx/Vitis_HLS/2022.1/tps/mingw/8.3.0/win64.o/nt\\lib\\gcc\\x86_64-w64-mingw32\\8.3.0\\include\\c++\\stdlib.h" 3
using std::div_t;
using std::ldiv_t;
...
# 43 "C:/Xilinx/Vitis_HLS/2022.1/tps/mingw/8.3.0/win64.o/nt\\lib\\gcc\\x86_64-w64-mingw32\\8.3.0\\include\\c++\\cmath" 2 3
...
# 44 "C:/Xilinx/Vitis_HLS/2022.1/tps/mingw/8.3.0/win64.o/nt\\lib\\gcc\\x86_64-w64-mingw32\\8.3.0\\include\\c++\\cmath" 2 3
...
# 2 "dataflow_ex_5.cpp" 2

void readDram(char *input, char input_buf[4][2][2], int channel_i)
{
    VITIS_LOOP_5_1: for (int hi = 0; hi < 2; hi++)
    {
        VITIS_LOOP_7_2: for (int wi = 0; wi < 2; wi++)
        {
...
Loop_Weight_Dram:
    ...
    {
        VITIS_LOOP_21_1: for (int ci = 0; ci < 2; ci++)
        {
...
void run_PE(char input_buf[4][2][2], char weight_buf[4][2][2], int output_buf[2][2], int channel_i)
{
    ...
    int output_reg[2][2];
    int output_temp[2][2];
# 55 "dataflow_ex_5.cpp"
    VITIS_LOOP_55_1: for (int ki = 0; ki < 2; ki++)
    {
        VITIS_LOOP_57_2: for (int ci = 0; ci < 2; ci++)
        {
    ...
    VITIS_LOOP_65_3: for (int ki = 0; ki < 2; ki++)
    {
        int sum = 0;
        VITIS_LOOP_68_4: for (int ci = 0; ci < 2; ci++)
        {
...
__attribute__((sdx_kernel("dataflow", 0))) void dataflow(
    char *input,
    char *weight,
    int *output)
{
#line 17 "C:/Users/gudtj/OneDrive/Desktop/24-2/SoC/HTL_Practice/241107/dataflow/solution1/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=dataflow
# 97 "dataflow_ex_5.cpp"
...
#pragma HLS ARRAY_PARTITION variable=weight_buf dim=2 complete
 ...
 VITIS_LOOP_112_1: for (int channel_i = 0; channel_i < 4; channel_i++)
    {
#pragma HLS DATAFLOW
