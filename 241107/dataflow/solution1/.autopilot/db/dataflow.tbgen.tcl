...
set C_modelArgList {
	...
	{ weight int 64 unused {axi_slave 0}  }
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem0", "interface" : "axi_master", "bitwidth" : 8, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "input_r","offset": { "type": "dynamic","port_name": "input_r","bundle": "control"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "gmem2", "interface" : "axi_master", "bitwidth" : 8, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "weight","offset": { "type": "dynamic","port_name": "weight","bundle": "control"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "gmem1", "interface" : "axi_master", "bitwidth" : 64, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "output_r","offset": { "type": "dynamic","port_name": "output_r","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
...
set portList { 
	...
	{ m_axi_gmem1_WDATA sc_out sc_lv 64 signal 2 } 
	{ m_axi_gmem1_WSTRB sc_out sc_lv 8 signal 2 } 
	...
	{ m_axi_gmem1_RDATA sc_in sc_lv 64 signal 2 } 
...
set NewPortList {[ 
	{ "name": "s_axi_control_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "control", "role": "AWADDR" },"address":[{"name":"dataflow","role":"start","value":"0","valid_bit":"0"},{"name":"dataflow","role":"continue","value":"0","valid_bit":"4"},{"name":"dataflow","role":"auto_start","value":"0","valid_bit":"7"},{"name":"input_r","role":"data","value":"16"},{"name":"weight","role":"data","value":"28"},{"name":"output_r","role":"data","value":"40"}] },
	...
	{ "name": "s_axi_control_ARADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "control", "role": "ARADDR" },"address":[{"name":"dataflow","role":"start","value":"0","valid_bit":"0"},{"name":"dataflow","role":"done","value":"0","valid_bit":"1"},{"name":"dataflow","role":"idle","value":"0","valid_bit":"2"},{"name":"dataflow","role":"ready","value":"0","valid_bit":"3"},{"name":"dataflow","role":"auto_start","value":"0","valid_bit":"7"}] },
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4", "5"],
		...
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "454", "EstimateLatencyMax" : "454",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "1",
		...
		"IsBlackBox" : "0",
		"InputProcess" : [
			{"ID" : "5", "Name" : "dataflow_in_loop_VITIS_LOOP_112_1_U0"}],
		"OutputProcess" : [
			{"ID" : "5", "Name" : "dataflow_in_loop_VITIS_LOOP_112_1_U0"}],
		"Port" : [
			{"Name" : "gmem0", "Type" : "MAXI", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "5", "SubInstance" : "dataflow_in_loop_VITIS_LOOP_112_1_U0", "Port" : "gmem0"}]},
			{"Name" : "gmem2", "Type" : "MAXI", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "5", "SubInstance" : "dataflow_in_loop_VITIS_LOOP_112_1_U0", "Port" : "gmem2"}]},
			{"Name" : "gmem1", "Type" : "MAXI", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "5", "SubInstance" : "dataflow_in_loop_VITIS_LOOP_112_1_U0", "Port" : "gmem1"}]},
			{"Name" : "input_r", "Type" : "None", "Direction" : "I"},
			{"Name" : "weight", "Type" : "None", "Direction" : "I"},
			{"Name" : "output_r", "Type" : "None", "Direction" : "I"}],
		"Loop" : [
			{"Name" : "VITIS_LOOP_112_1", "PipelineType" : "dataflow",
				"LoopDec" : {"InfiniteLoop" : "0", "BodyInst" : "dataflow_in_loop_VITIS_LOOP_112_1_U0", "has_continue" : "0"}}]},
	...
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.dataflow_in_loop_VITIS_LOOP_112_1_U0", "Parent" : "0", "Child" : ["6", "7", "8", "9", "10", "11", "12", "13", "14", "20", "21", "22"],
		...
		"InputProcess" : [
			...
			{"ID" : "12", "Name" : "readDram_U0"},
			{"ID" : "13", "Name" : "weightDram_U0"}],
		"OutputProcess" : [
			{"ID" : "20", "Name" : "writeDram_U0"}],
		"Port" : [
			{"Name" : "gmem0", "Type" : "MAXI", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "12", "SubInstance" : "readDram_U0", "Port" : "gmem0"}]},
			{"Name" : "channel_i", "Type" : "None", "Direction" : "I"},
			{"Name" : "gmem2", "Type" : "MAXI", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "13", "SubInstance" : "weightDram_U0", "Port" : "gmem2"}]},
			{"Name" : "gmem1", "Type" : "MAXI", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "20", "SubInstance" : "writeDram_U0", "Port" : "gmem1"}]},
			{"Name" : "output_r", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "6", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.dataflow_in_loop_VITIS_LOOP_112_1_U0.input_buf_U", "Parent" : "5"},
	{"ID" : "7", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.dataflow_in_loop_VITIS_LOOP_112_1_U0.input_buf_1_U", "Parent" : "5"},
	{"ID" : "8", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.dataflow_in_loop_VITIS_LOOP_112_1_U0.weight_buf_U", "Parent" : "5"},
	{"ID" : "9", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.dataflow_in_loop_VITIS_LOOP_112_1_U0.weight_buf_1_U", "Parent" : "5"},
	{"ID" : "10", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.dataflow_in_loop_VITIS_LOOP_112_1_U0.output_buf_U", "Parent" : "5"},
	{"ID" : "11", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.dataflow_in_loop_VITIS_LOOP_112_1_U0.entry_proc_U0", "Parent" : "5",
		"CDFG" : "entry_proc",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "1", "ap_idle" : "1", "real_start" : "0",
		...
		"Port" : [
			{"Name" : "output_r", "Type" : "None", "Direction" : "I"},
			{"Name" : "output_r_c", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["20"], "DependentChan" : "21", "DependentChanDepth" : "4", "DependentChanType" : "2",
				"BlockSignal" : [
					{"Name" : "output_r_c_blk_n", "Type" : "RtlSignal"}]}]},
	{"ID" : "12", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.dataflow_in_loop_VITIS_LOOP_112_1_U0.readDram_U0", "Parent" : "5",
		"CDFG" : "readDram",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "1", "ap_idle" : "1", "real_start" : "0",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		...
		"Port" : [
			...
			{"Name" : "input_buf", "Type" : "Memory", "Direction" : "O", "DependentProc" : ["14"], "DependentChan" : "6"},
			{"Name" : "input_buf_1", "Type" : "Memory", "Direction" : "O", "DependentProc" : ["14"], "DependentChan" : "7"},
			{"Name" : "channel_i", "Type" : "None", "Direction" : "I"}],
		"Loop" : [
			{"Name" : "VITIS_LOOP_7_2", "PipelineType" : "no",
				"LoopDec" : {"FSMBitwidth" : "74", "FirstState" : "ap_ST_fsm_state72", "LastState" : ["ap_ST_fsm_state74"], "QuitState" : ["ap_ST_fsm_state72"], "PreState" : ["ap_ST_fsm_state71"], "PostState" : ["ap_ST_fsm_state71"], "OneDepthLoop" : "0", "OneStateBlock": ""}},
			{"Name" : "VITIS_LOOP_5_1", "PipelineType" : "no",
				"LoopDec" : {"FSMBitwidth" : "74", "FirstState" : "ap_ST_fsm_state71", "LastState" : ["ap_ST_fsm_state72"], "QuitState" : ["ap_ST_fsm_state71"], "PreState" : ["ap_ST_fsm_state70"], "PostState" : ["ap_ST_fsm_state1"], "OneDepthLoop" : "0", "OneStateBlock": ""}}]},
	{"ID" : "13", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.dataflow_in_loop_VITIS_LOOP_112_1_U0.weightDram_U0", "Parent" : "5",
		"CDFG" : "weightDram",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "1", "ap_idle" : "1", "real_start" : "0",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		...
		"Port" : [
			...
			{"Name" : "weight_buf", "Type" : "Memory", "Direction" : "O", "DependentProc" : ["14"], "DependentChan" : "8"},
			{"Name" : "weight_buf_1", "Type" : "Memory", "Direction" : "O", "DependentProc" : ["14"], "DependentChan" : "9"},
			{"Name" : "channel_i", "Type" : "None", "Direction" : "I"}],
		"Loop" : [
			{"Name" : "VITIS_LOOP_21_1", "PipelineType" : "no",
				"LoopDec" : {"FSMBitwidth" : "74", "FirstState" : "ap_ST_fsm_state72", "LastState" : ["ap_ST_fsm_state74"], "QuitState" : ["ap_ST_fsm_state72"], "PreState" : ["ap_ST_fsm_state71"], "PostState" : ["ap_ST_fsm_state71"], "OneDepthLoop" : "0", "OneStateBlock": ""}},
			{"Name" : "Loop_Weight_Dram", "PipelineType" : "no",
				"LoopDec" : {"FSMBitwidth" : "74", "FirstState" : "ap_ST_fsm_state71", "LastState" : ["ap_ST_fsm_state72"], "QuitState" : ["ap_ST_fsm_state71"], "PreState" : ["ap_ST_fsm_state70"], "PostState" : ["ap_ST_fsm_state1"], "OneDepthLoop" : "0", "OneStateBlock": ""}}]},
	{"ID" : "14", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.dataflow_in_loop_VITIS_LOOP_112_1_U0.run_PE_U0", "Parent" : "5", "Child" : ["15", "16", "17", "18", "19"],
		"CDFG" : "run_PE",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "1", "ap_idle" : "1", "real_start" : "0",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "input_buf1", "Type" : "Memory", "Direction" : "I", "DependentProc" : ["12"], "DependentChan" : "6"},
			{"Name" : "input_buf_12", "Type" : "Memory", "Direction" : "I", "DependentProc" : ["12"], "DependentChan" : "7"},
			{"Name" : "weight_buf3", "Type" : "Memory", "Direction" : "I", "DependentProc" : ["13"], "DependentChan" : "8"},
			{"Name" : "weight_buf_14", "Type" : "Memory", "Direction" : "I", "DependentProc" : ["13"], "DependentChan" : "9"},
			{"Name" : "output_buf5", "Type" : "Memory", "Direction" : "O", "DependentProc" : ["20"], "DependentChan" : "10"},
	...
	{"ID" : "15", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.dataflow_in_loop_VITIS_LOOP_112_1_U0.run_PE_U0.output_reg_U", "Parent" : "14"},
	{"ID" : "16", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.dataflow_in_loop_VITIS_LOOP_112_1_U0.run_PE_U0.output_temp_0_U", "Parent" : "14"},
	{"ID" : "17", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.dataflow_in_loop_VITIS_LOOP_112_1_U0.run_PE_U0.mux_22_8_1_1_U11", "Parent" : "14"},
	{"ID" : "18", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.dataflow_in_loop_VITIS_LOOP_112_1_U0.run_PE_U0.mux_22_8_1_1_U12", "Parent" : "14"},
	{"ID" : "19", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.dataflow_in_loop_VITIS_LOOP_112_1_U0.run_PE_U0.mul_8s_8s_16_1_1_U13", "Parent" : "14"},
	{"ID" : "20", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.dataflow_in_loop_VITIS_LOOP_112_1_U0.writeDram_U0", "Parent" : "5",
		"CDFG" : "writeDram",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "1", "ap_idle" : "1", "real_start" : "0",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "output_buf", "Type" : "Memory", "Direction" : "I", "DependentProc" : ["14"], "DependentChan" : "10"},
			{"Name" : "gmem1", "Type" : "MAXI", "Direction" : "O",
				"BlockSignal" : [
					{"Name" : "gmem1_blk_n_AW", "Type" : "RtlSignal"},
					{"Name" : "gmem1_blk_n_W", "Type" : "RtlSignal"},
					{"Name" : "gmem1_blk_n_B", "Type" : "RtlSignal"}]},
			{"Name" : "output_r", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["11"], "DependentChan" : "21", "DependentChanDepth" : "4", "DependentChanType" : "2",
				"BlockSignal" : [
					{"Name" : "output_r_blk_n", "Type" : "RtlSignal"}]}],
		"Loop" : [
			{"Name" : "Loop_Write_Dram", "PipelineType" : "no",
				"LoopDec" : {"FSMBitwidth" : "73", "FirstState" : "ap_ST_fsm_state2", "LastState" : ["ap_ST_fsm_state3"], "QuitState" : ["ap_ST_fsm_state2"], "PreState" : ["ap_ST_fsm_state1"], "PostState" : ["ap_ST_fsm_state4"], "OneDepthLoop" : "0", "OneStateBlock": ""}}]},
	{"ID" : "21", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.dataflow_in_loop_VITIS_LOOP_112_1_U0.output_r_c_U", "Parent" : "5"},
	{"ID" : "22", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.dataflow_in_loop_VITIS_LOOP_112_1_U0.tmp_U", "Parent" : "5"}]}
...
set ArgLastReadFirstWriteLatency {
	...
	dataflow_in_loop_VITIS_LOOP_112_1 {
		gmem0 {Type I LastRead 72 FirstWrite -1}
		channel_i {Type I LastRead 0 FirstWrite -1}
		gmem2 {Type I LastRead 72 FirstWrite -1}
		gmem1 {Type O LastRead 4 FirstWrite 3}
	...
	readDram {
		gmem0 {Type I LastRead 72 FirstWrite -1}
		input_buf {Type O LastRead -1 FirstWrite 73}
		input_buf_1 {Type O LastRead -1 FirstWrite 73}
		channel_i {Type I LastRead 69 FirstWrite -1}}
	weightDram {
		gmem2 {Type I LastRead 72 FirstWrite -1}
		weight_buf {Type O LastRead -1 FirstWrite 73}
		weight_buf_1 {Type O LastRead -1 FirstWrite 73}
		channel_i {Type I LastRead 69 FirstWrite -1}}
	run_PE {
