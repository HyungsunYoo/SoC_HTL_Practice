...
set C_modelArgMapList {[ 
	{ "Name" : "gmem0", "interface" : "axi_master", "bitwidth" : 8, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "input_r","offset": { "type": "dynamic","port_name": "input_r","bundle": "control"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "channel_i", "interface" : "wire", "bitwidth" : 3, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ channel_i sc_in sc_lv 3 signal 1 } 
	...
	{ m_axi_gmem2_WDATA sc_out sc_lv 8 signal 2 } 
	{ m_axi_gmem2_WSTRB sc_out sc_lv 1 signal 2 } 
	...
	{ m_axi_gmem2_RDATA sc_in sc_lv 8 signal 2 } 
	{ m_axi_gmem2_RLAST sc_in sc_logic 1 signal 2 } 
	{ m_axi_gmem2_RID sc_in sc_lv 1 signal 2 } 
	{ m_axi_gmem2_RFIFONUM sc_in sc_lv 11 signal 2 } 
	...
	{ m_axi_gmem1_WDATA sc_out sc_lv 64 signal 3 } 
	{ m_axi_gmem1_WSTRB sc_out sc_lv 8 signal 3 } 
	...
	{ m_axi_gmem1_RDATA sc_in sc_lv 64 signal 3 } 
	...
	{ output_r_ap_vld sc_in sc_logic 1 invld 4 } 
	{ ap_start sc_in sc_logic 1 start -1 } 
	{ channel_i_ap_vld sc_in sc_logic 1 invld 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "channel_i", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "channel_i", "role": "default" }} , 
 	...
 	{ "name": "channel_i_ap_vld", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "invld", "bundle":{"name": "channel_i", "role": "ap_vld" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4", "5", "6", "7", "8", "9", "15", "16", "17"],
		...
		"InputProcess" : [
			...
			{"ID" : "7", "Name" : "readDram_U0"},
			{"ID" : "8", "Name" : "weightDram_U0"}],
		"OutputProcess" : [
			{"ID" : "15", "Name" : "writeDram_U0"}],
		"Port" : [
			{"Name" : "gmem0", "Type" : "MAXI", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "7", "SubInstance" : "readDram_U0", "Port" : "gmem0"}]},
			{"Name" : "channel_i", "Type" : "None", "Direction" : "I"},
			{"Name" : "gmem2", "Type" : "MAXI", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "8", "SubInstance" : "weightDram_U0", "Port" : "gmem2"}]},
			{"Name" : "gmem1", "Type" : "MAXI", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "15", "SubInstance" : "writeDram_U0", "Port" : "gmem1"}]},
	...
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.output_buf_U", "Parent" : "0"},
	{"ID" : "6", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.entry_proc_U0", "Parent" : "0",
		...
		"Port" : [
			{"Name" : "output_r", "Type" : "None", "Direction" : "I"},
			{"Name" : "output_r_c", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["15"], "DependentChan" : "16", "DependentChanDepth" : "4", "DependentChanType" : "2",
				"BlockSignal" : [
					{"Name" : "output_r_c_blk_n", "Type" : "RtlSignal"}]}]},
	{"ID" : "7", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.readDram_U0", "Parent" : "0",
		"CDFG" : "readDram",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "1", "ap_idle" : "1", "real_start" : "0",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		...
		"Port" : [
			...
			{"Name" : "input_buf", "Type" : "Memory", "Direction" : "O", "DependentProc" : ["9"], "DependentChan" : "1"},
			{"Name" : "input_buf_1", "Type" : "Memory", "Direction" : "O", "DependentProc" : ["9"], "DependentChan" : "2"},
			{"Name" : "channel_i", "Type" : "None", "Direction" : "I"}],
		"Loop" : [
	...
	{"ID" : "8", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.weightDram_U0", "Parent" : "0",
		"CDFG" : "weightDram",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "1", "ap_idle" : "1", "real_start" : "0",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		...
		"Port" : [
			...
			{"Name" : "weight_buf", "Type" : "Memory", "Direction" : "O", "DependentProc" : ["9"], "DependentChan" : "3"},
			{"Name" : "weight_buf_1", "Type" : "Memory", "Direction" : "O", "DependentProc" : ["9"], "DependentChan" : "4"},
			{"Name" : "channel_i", "Type" : "None", "Direction" : "I"}],
		"Loop" : [
			...
			{"Name" : "Loop_Weight_Dram", "PipelineType" : "no",
				"LoopDec" : {"FSMBitwidth" : "74", "FirstState" : "ap_ST_fsm_state71", "LastState" : ["ap_ST_fsm_state72"], "QuitState" : ["ap_ST_fsm_state71"], "PreState" : ["ap_ST_fsm_state70"], "PostState" : ["ap_ST_fsm_state1"], "OneDepthLoop" : "0", "OneStateBlock": ""}}]},
	{"ID" : "9", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.run_PE_U0", "Parent" : "0", "Child" : ["10", "11", "12", "13", "14"],
		"CDFG" : "run_PE",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "1", "ap_idle" : "1", "real_start" : "0",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "input_buf1", "Type" : "Memory", "Direction" : "I", "DependentProc" : ["7"], "DependentChan" : "1"},
			{"Name" : "input_buf_12", "Type" : "Memory", "Direction" : "I", "DependentProc" : ["7"], "DependentChan" : "2"},
			{"Name" : "weight_buf3", "Type" : "Memory", "Direction" : "I", "DependentProc" : ["8"], "DependentChan" : "3"},
			{"Name" : "weight_buf_14", "Type" : "Memory", "Direction" : "I", "DependentProc" : ["8"], "DependentChan" : "4"},
			{"Name" : "output_buf5", "Type" : "Memory", "Direction" : "O", "DependentProc" : ["15"], "DependentChan" : "5"},
			{"Name" : "p_read", "Type" : "None", "Direction" : "I", "DependentProc" : ["7"], "DependentChan" : "17", "DependentChanDepth" : "2", "DependentChanType" : "1"}],
		"Loop" : [
	...
	{"ID" : "10", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.run_PE_U0.output_reg_U", "Parent" : "9"},
	{"ID" : "11", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.run_PE_U0.output_temp_0_U", "Parent" : "9"},
	{"ID" : "12", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.run_PE_U0.mux_22_8_1_1_U11", "Parent" : "9"},
	{"ID" : "13", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.run_PE_U0.mux_22_8_1_1_U12", "Parent" : "9"},
	{"ID" : "14", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.run_PE_U0.mul_8s_8s_16_1_1_U13", "Parent" : "9"},
	{"ID" : "15", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.writeDram_U0", "Parent" : "0",
		"CDFG" : "writeDram",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "1", "ap_idle" : "1", "real_start" : "0",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "output_buf", "Type" : "Memory", "Direction" : "I", "DependentProc" : ["9"], "DependentChan" : "5"},
			{"Name" : "gmem1", "Type" : "MAXI", "Direction" : "O",
				"BlockSignal" : [
					{"Name" : "gmem1_blk_n_AW", "Type" : "RtlSignal"},
					{"Name" : "gmem1_blk_n_W", "Type" : "RtlSignal"},
					{"Name" : "gmem1_blk_n_B", "Type" : "RtlSignal"}]},
			{"Name" : "output_r", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["6"], "DependentChan" : "16", "DependentChanDepth" : "4", "DependentChanType" : "2",
				"BlockSignal" : [
	...
	{"ID" : "16", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.output_r_c_U", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	channel_i { ap_none {  { channel_i in_data 0 3 }  { channel_i_ap_vld in_vld 0 1 } } }
