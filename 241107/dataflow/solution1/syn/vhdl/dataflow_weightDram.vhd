...
architecture behav of dataflow_weightDram is 
...
attribute shreg_extract : string;
    ...
    signal tmp_i_fu_133_p3 : STD_LOGIC_VECTOR (2 downto 0);
    signal tmp_i_reg_204 : STD_LOGIC_VECTOR (2 downto 0);
    signal ap_CS_fsm_state70 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state70 : signal is "none";
    signal add_ln19_fu_150_p2 : STD_LOGIC_VECTOR (1 downto 0);
    signal add_ln19_reg_212 : STD_LOGIC_VECTOR (1 downto 0);
    signal ap_CS_fsm_state71 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state71 : signal is "none";
    signal empty_31_fu_156_p1 : STD_LOGIC_VECTOR (0 downto 0);
    signal empty_31_reg_217 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln19_fu_144_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal weight_buf_addr_reg_221 : STD_LOGIC_VECTOR (2 downto 0);
    signal ap_CS_fsm_state72 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state72 : signal is "none";
    signal weight_buf_1_addr_reg_226 : STD_LOGIC_VECTOR (2 downto 0);
    signal add_ln21_fu_181_p2 : STD_LOGIC_VECTOR (1 downto 0);
    signal add_ln21_reg_234 : STD_LOGIC_VECTOR (1 downto 0);
    signal gmem2_addr_read_reg_239 : STD_LOGIC_VECTOR (7 downto 0);
    signal ci_reg_110 : STD_LOGIC_VECTOR (1 downto 0);
    signal ap_CS_fsm_state74 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state74 : signal is "none";
    signal zext_ln24_1_fu_169_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_block_state1 : BOOLEAN;
    signal ki_fu_64 : STD_LOGIC_VECTOR (1 downto 0);
    signal icmp_ln21_fu_175_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal zext_ln24_fu_160_p1 : STD_LOGIC_VECTOR (2 downto 0);
    signal add_ln24_fu_164_p2 : STD_LOGIC_VECTOR (2 downto 0);
...
begin
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((ap_continue = ap_const_logic_1)) then 
                    ap_done_reg <= ap_const_logic_0;
                elsif (((ap_const_logic_1 = ap_CS_fsm_state71) and (icmp_ln19_fu_144_p2 = ap_const_lv1_1))) then 
    ...
    ci_reg_110_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state71) and (icmp_ln19_fu_144_p2 = ap_const_lv1_0))) then 
                ci_reg_110 <= ap_const_lv2_0;
    ...
    ki_fu_64_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((not(((ap_done_reg = ap_const_logic_1) or (ap_start = ap_const_logic_0) or (m_axi_gmem2_ARREADY = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
                ki_fu_64 <= ap_const_lv2_0;
            elsif (((icmp_ln21_fu_175_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state72))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state72)) then
                ...
                weight_buf_1_addr_reg_226 <= zext_ln24_1_fu_169_p1(3 - 1 downto 0);
                weight_buf_addr_reg_221 <= zext_ln24_1_fu_169_p1(3 - 1 downto 0);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state70)) then
                    tmp_i_reg_204(2 downto 1) <= tmp_i_fu_133_p3(2 downto 1);
            end if;
        end if;
    end process;
    tmp_i_reg_204(0) <= '0';

    ap_NS_fsm_assign_proc : process (ap_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, m_axi_gmem2_ARREADY, m_axi_gmem2_RVALID, ap_CS_fsm_state73, ap_CS_fsm_state71, icmp_ln19_fu_144_p2, ap_CS_fsm_state72, icmp_ln21_fu_175_p2)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state71 => 
                if (((ap_const_logic_1 = ap_CS_fsm_state71) and (icmp_ln19_fu_144_p2 = ap_const_lv1_1))) then
                    ap_NS_fsm <= ap_ST_fsm_state1;
                else
                    ap_NS_fsm <= ap_ST_fsm_state72;
                end if;
            when ap_ST_fsm_state72 => 
                if (((icmp_ln21_fu_175_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state72))) then
                    ap_NS_fsm <= ap_ST_fsm_state71;
                else
    ...
    add_ln19_fu_150_p2 <= std_logic_vector(unsigned(ki_fu_64) + unsigned(ap_const_lv2_1));
    add_ln21_fu_181_p2 <= std_logic_vector(unsigned(ci_reg_110) + unsigned(ap_const_lv2_1));
    add_ln24_fu_164_p2 <= std_logic_vector(unsigned(tmp_i_reg_204) + unsigned(zext_ln24_fu_160_p1));
    ...
    ap_ST_fsm_state1_blk_assign_proc : process(ap_start, ap_done_reg, m_axi_gmem2_ARREADY)
    begin
        if (((ap_done_reg = ap_const_logic_1) or (ap_start = ap_const_logic_0) or (m_axi_gmem2_ARREADY = ap_const_logic_0))) then 
    ...
    ap_ST_fsm_state73_blk_assign_proc : process(m_axi_gmem2_RVALID)
    begin
        if ((m_axi_gmem2_RVALID = ap_const_logic_0)) then 
    ...
    ap_done_assign_proc : process(ap_done_reg, ap_CS_fsm_state71, icmp_ln19_fu_144_p2)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state71) and (icmp_ln19_fu_144_p2 = ap_const_lv1_1))) then 
    ...
    ap_ready_assign_proc : process(ap_CS_fsm_state71, icmp_ln19_fu_144_p2)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state71) and (icmp_ln19_fu_144_p2 = ap_const_lv1_1))) then 
    ...
    empty_31_fu_156_p1 <= ki_fu_64(1 - 1 downto 0);
    ...
    icmp_ln19_fu_144_p2 <= "1" when (ki_fu_64 = ap_const_lv2_2) else "0";
    icmp_ln21_fu_175_p2 <= "1" when (ci_reg_110 = ap_const_lv2_2) else "0";
    ...
    m_axi_gmem2_ARVALID_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, m_axi_gmem2_ARREADY)
    begin
        if ((not(((ap_done_reg = ap_const_logic_1) or (ap_start = ap_const_logic_0) or (m_axi_gmem2_ARREADY = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    tmp_i_fu_133_p3 <= (channel_i & ap_const_lv1_0);
    weight_buf_1_address0 <= weight_buf_1_addr_reg_226;

    weight_buf_1_ce0_assign_proc : process(ap_CS_fsm_state74)
    begin
    ...
    weight_buf_1_d0 <= gmem2_addr_read_reg_239;

    weight_buf_1_we0_assign_proc : process(empty_31_reg_217, ap_CS_fsm_state74)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state74) and (empty_31_reg_217 = ap_const_lv1_1))) then 
    ...
    weight_buf_address0 <= weight_buf_addr_reg_221;

    weight_buf_ce0_assign_proc : process(ap_CS_fsm_state74)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state74)) then 
    ...
    weight_buf_d0 <= gmem2_addr_read_reg_239;

    weight_buf_we0_assign_proc : process(empty_31_reg_217, ap_CS_fsm_state74)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state74) and (empty_31_reg_217 = ap_const_lv1_0))) then 
    ...
    zext_ln24_1_fu_169_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln24_fu_164_p2),64));
    zext_ln24_fu_160_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ci_reg_110),3));
end behav;
